...
set CLASSPATH=%SHARED_LIB%\activation.jar;%SHARED_LIB%\jax-qname.jar;%SAAJ_LIB%\saaj-api.jar;%SAAJ_LIB%\saaj-impl.jar;%JAXP_LIB%\..\jaxp-api.jar;%JAXP_LIB%\sax.jar;%JAXP_LIB%\dom.jar;%JAXP_LIB%\xercesImpl.jar;%JAXP_LIB%\xalan.jar;

java -classpath %CLASSPATH% TimeServer
